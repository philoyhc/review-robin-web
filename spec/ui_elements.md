...
- **`spec/visual_style_general.md`** — authoritative design system (palette,
  ...
  current codebase.
- **`spec/assumptions.md`** — load-bearing domain assumptions
...
renders. (Moved here from `spec/assumptions.md` 2026-05-11.)
...
`spec/visual_style_general.md`. The historical content has been
moved to **`guide/archive/ui_elements_parts_2_3_restyle_history.md`**
so anyone tracing a v2-era template back to its driving spec
entry can still read the migration shape.

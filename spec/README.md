...
| `color_tokens.md` | Two-tier colour-token catalogue — the Tier 1 primitives (descriptive palette) + the Tier 2 semantic tokens by cluster (light/dark primitive + resolved hex, `[P]`/`[A]`), plus the couplings registry and non-colour scale tokens. Design + rationale in `guide/semantic_tokens.md`. |

...
**As of:** end of Segment 13D (2026-05-09) — schema bedrock for the operator RTD / RuleSet library / per-session-copy split, plus the friendly-label resolver table and the 13B / 13C ride-along columns

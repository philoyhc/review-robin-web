...
Optional columns (used by the Segment 13 RuleBased assignment
...
logic** — RuleBased rules (Segment 13) ignore it. The reviewer
...
`pair_context_1` … `assignment_context_3`. Used by Segment 13
...
- RuleBased assignment generation (Segment 13).

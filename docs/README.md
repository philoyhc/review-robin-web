...
| `quickstart.md` | **Operator manual** — a simple end-to-end walkthrough for a colleague running their first review (create → set up → activate → invite → monitor → release results). Carries marked slots for screen captures. |

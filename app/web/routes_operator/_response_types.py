...
# Segment 18J Wave 2 PR iii-b3 — the RTD library tier retired.
# The two routes that lived here (save-to-library +
# add-from-library) are gone alongside the
# operator_response_type_definitions table.

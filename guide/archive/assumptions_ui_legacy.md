# `spec/domain_assumptions.md` — legacy UI section (archived)

**Archived from `spec/domain_assumptions.md` 2026-05-11** per
...
`spec/domain_assumptions.md` for eight days as a transition aid;
this file is their landing zone.

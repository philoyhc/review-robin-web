...
| `observers.md` | ~290 | Standing notes for the observer participant role — storage shape (`observers.cohort_rule` JSON), token design decisions, the "where the wiring stands" + consumer + operator route list. Archived 2026-06-03 once the observer ladder closed (`guide/clean_up.md` items 13-16 all shipped). The shipped behaviour is captured in `spec/participant_model.md` + `spec/setup_pages.md` + `spec/csv_contracts.md` + `spec/extract_data.md`; this file is the design-decision record. |

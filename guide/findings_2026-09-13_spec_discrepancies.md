...
**31 of 83 resolved. 52 open.**

| what the open rows need | ids | count |
|---|---|---|
| **a ruling** — which side is right | `SC-05`, `SC-06`, `SC-08`, `SC-10`…`SC-36` | 30 |
| **a contract now ruled** — assignments are always generated, planned in `guide/segment_19N_generated_assignments.md` | `SC-37`, `SC-38`, `SC-40`, `SC-42`, `SC-43` | 5 |

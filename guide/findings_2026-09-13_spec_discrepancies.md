...
**43 of 85 resolved. 42 open.**

| what the open rows need | ids | count |
|---|---|---|
| **a ruling** — which side is right | `SC-05`, `SC-12`…`SC-15`, `SC-17`, `SC-19`…`SC-21`, `SC-23`, `SC-24`, `SC-26`…`SC-31`, `SC-33`…`SC-36` | 21 |
...
the audience rather than count the cards. Four (a) rows were left open
deliberately (`SC-05`, `SC-12`, `SC-19`, `SC-29`): each needs a judgement the
code alone does not settle, and three of them look like they may belong in (b).

...
- **#1838, #1839** — Two addendum updates to `guide/weaknesses_and_bugs_found_by_codex.md` reflecting ship status as Slices A/B/C, then the Codex P1 follow-up, landed.

...
- **Segment 11J — Quick Setup wiring** — done 2026-05-07. PRs **#526 → #527 → #528**.
  ...
  - Plan: `guide/segment_11J_quick_setup_card.md`. Catalog `unfinished_business.md` #30 (closed by this segment, modulo slot 4 which carries forward into 12A).

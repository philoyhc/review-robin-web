...
### Segment 19O — Rosters and instruments — 🔵 **live** (**six items, all closed; segment open** — 1–6; opened 2026-09-14; PRs #2382 → #2455; a home for operator-facing gaps on the roster and instrument setup surfaces; plan: `guide/segment_19O_rosters_and_instruments.md`)

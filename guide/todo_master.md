...
- **Item 2 (11F)** builds out the Previews tab — the only Operations-row tab still on a placeholder. Shares list-with-bulk-actions patterns with 11C Part 1 (already shipped) so the chrome wiring is already settled.

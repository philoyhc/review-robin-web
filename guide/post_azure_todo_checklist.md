...
| A page turn keeps your place (2026-09-11, 19J.8) | Same roster: scroll to the pager **below** the table and click the next range | The new page opens with the **table** at the top of the viewport, not the page header — and with a little space above it, not flush against the edge. The address bar shows the `#…-table` fragment, which is expected |

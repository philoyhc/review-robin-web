...
| `page_help_text.md` | Working drafts of the per-page `<details class="page-guidance">` help copy for the six Setup pages (Segment 19E rung 6). A drafting surface, not a contract — the shipped text lives in the page templates and the scaffold's contract in `spec/setup_pages.md`. Retires to `archive/` with the 19E plan once rung 6b lands. |

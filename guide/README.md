...
| `instrument_builder_project.md` | Multi-segment design plan for the per-instrument card. Parts 0/1/1b/1c/1d/2 shipped under Segments 18I + 18J; Parts 3-9 (Links 4 / 5 / 6 — Visibility / Read shape / Release timing including observer audiences) remain future work. |

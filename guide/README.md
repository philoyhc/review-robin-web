...
| `landing_pages.md` | Standing notes for the **landing-pages** work (Segment 18R Item 6): audit of the current entry routes (`/` serves JSON, `/operator` 404s, no role-aware routing), the gaps, the URLs that want a landing page, and the redirect-vs-home-hub recommendation with a landing-by-role decision table + scaffold-first slices. |
